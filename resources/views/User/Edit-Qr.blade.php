                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="{{ url('editQrSubmit/'.$data[0]->id) }}" method="post" novalidate="novalidate" id="form">
                                    @csrf
                                    <div class="form-group has-success">
                                        ...
                                        <input id="name" name="name" type="text" class="form-control cc-name valid"
                                            ...
                                            aria-describedby="cc-name-error" value="{{ $data[0]->qr_name }}">
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <input id="link" name="link" type="text" class="form-control cc-name valid"
                                            data-val="true" data-val-required="Please enter the name on card"
                                            autocomplete="cc-name" aria-required="true" aria-invalid="false"
                                            aria-describedby="cc-name-error" value="{{ $data[0]->link }}">
                                        <span class="help-block field-validation-valid" data-valmsg-for="cc-name"
                                            data-valmsg-replace="true"></span>
                                        @error('link')
                                            <p class="text-danger p-1">{{ $message }}</p>
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <select id="size" name="size" type="text" class="form-control cc-name valid"
                                            ...
                                            @foreach ($size as $item)
                                                @if ($data[0]->size == $item->size)
                                                    <option value="{{ $item->size }}" class="form-control" selected>
                                                        {{ $item->size }}
                                                    </option>
                                                @else
                                                    <option value="{{ $item->size }}" class="form-control">
                                                        {{ $item->size }}
                                                    </option>
                                                @endif
                                            @endforeach
                                    ...
                                    <div class="form-group has-success">
                                        ...
                                        <select id="color" name="color" type="text" class="form-control cc-name valid"
                                            ...
                                            @foreach ($color as $item)
                                                @if ($data[0]->color == $item->color)
                                                    <option value="{{ $item->color }}" class="form-control" selected>
                                                        {{ $item->color }}
                                                    </option>
                                                @else
                                                    <option value="{{ $item->color }}" class="form-control">
                                                        {{ $item->color }}
                                                    </option>
                                                @endif
                                            @endforeach
