...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a @if (session('role')==1) href="{{ url('/') }}">
                    @else
                    href="{{ url('/Profile') }}"> @endif <label class="font-weight-bold">QR -
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        @if(session('role') == 0)
                        <li class="@yield('Change_user_detail') has-sub">
                            <a class="js-arrow" href="{{ url('/User-Detail') }}">
                                <i class="fas fa-eye"></i>{{session('name')}} Details</a>
                        </li>
                        @endif
                    </ul>
                </nav>
